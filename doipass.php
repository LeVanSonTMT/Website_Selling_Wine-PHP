    ...
    <div class="main">
        ...
        <div id="divTable">
            <table border="0" id="bang1" cellpadding="0" style="border: 1px solid black;">
                <tr>
                    <td id="in33"><a href="./suaTTClient.php"> <img src="./hinhdaidien/anhX.jfif"></a></td>
                </tr>
                <tr>
                    <?php 
                        //tao ket noi
                        ...
                        // session_start();
                        $Xsdt=$_SESSION['sdt'];
                        $sql="SELECT mk From nguoidung WHERE sdt='$Xsdt'";
...
<?php
    ...
    {
        $bienMK = md5($_POST['pass1']);
        $sql = " UPDATE nguoidung SET mk='$bienMK' WHERE sdt='$Xsdt'";
        $conn->query($sql);
        echo "<script>alert('Cập nhật thành công!');</script>";
        echo "<meta http-equiv='refresh' content='0;URL=suaTTClient.php'>";
