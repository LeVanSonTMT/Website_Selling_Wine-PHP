    ...
    <div class="main">
        ...
        <div id="divTable">
            <table border="0" id="bang1">
                <tr>
                    <td id="in33"><a href="./khoiphucSP.php"> <img src="../hinhdaidien/anhX.jfif"></a></td>
                </tr>
                <tr>
                    <th>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data" name="formThemSP"
                            ...
                            <table border="0" id="bang3">
                                ...
                                <tr><td>Danh mục sản phẩm: 
                                    ...
                                    ?></td></tr>
                                <tr><td>Mã sản phẩm: <?php echo $masp ?></td></tr>
                                <tr>
                                    <td> Tên sản phẩm </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th id="thinput">
                                        <input class="in1" type="submit" name="OK" value="Phục Hồi" />
                                        <input class="in1" type="reset" name="huy" value="Hủy" />
                                    </th>
                                </tr>
                            </table>
                        </form>
...
<?php
    if(isset($_POST['OK']))
    {
        ...
        $sql = "UPDATE  sanpham SET 
                tenSP='$tenSP', 
                gioithieuSP='$gioithieuSP', nguyenlieuSP='$nguyenlieuSP',
                thetichSP='$thetichSP', doconSP='$doconSP', giaSP='$giaSP',
                noicungcapSP='$noicungcapSP', hinhanhSP='$hinhCu',
                khuyenmaiSP='$khuyenmaiSP', soluongSP='$soluongSP',thoigian=now(),
                ttSP=1     WHERE maSP='$maSPX'";
        $resutl = $conn->query($sql);
        if($resutl) echo "<script>alert('Khôi phục thành công!');</script>";
