    ...
    <div class="main">
        ...
        <div id="divTable">
            <table border='0' id="bang1" cellpadding="0">
                <tr>
                    <td id="in33"><a href="<?php $dc = $_GET['dc']; echo $dc; ?>">
                            <img src="./hinhdaidien/anhX.jfif" alt=""></a></td>
                </tr>
                <tr>
                    <th>
                        <h1> </h1>
                    ...
                    <td>
                        <table border='0' id="bang2" cellspacing="0">
                            ...
                            <?php                                                        
                                ...
                                //lay du lieu;
                                $bienX = $_SESSION['sdt'];
                                $maspmua = $_GET['maspmua'];
                                //tao ket noi
                                    include_once('./quantri/conn.php');
                                //viet cau lenh slp
                                    $sql="SELECT * FROM giohang where sdt='$bienX' and maSP='$maspmua' ";
                                //thuc hien truy van
                                    ...
                                    { 
                                        ...
                                        {
                                            $sqlSP = "SELECT * From sanpham where maSP='$maspmua'";
                            ...
                            <tr>
                                ...
                                <td> <?php echo $rowSP['khuyenmaiSP']; ?>% </td>
                                <td>
                                ...
                                <td><a
                                        href="xoaSPofGioHang.php?stt=<?php echo $row['STT']; ?>&dc=<?php echo $dc; ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php    $i=$i+1; }
                                 } 
