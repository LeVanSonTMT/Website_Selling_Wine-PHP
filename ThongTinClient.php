    ...
    <div class="main">
        ...
        <div id="divTable">
            ...
            <table border="0" id="bang1" cellpadding="0" style="border: 1px solid black;background-color: #d3d3d3;">
                <tr>
                    <th rowspan="3" width="250px" height="250px"><img
                            src="<?php echo $row['avt'] ?>" width="100%" height="100%" alt="not avt">
                    </th>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <th style="padding-top: 10px;"><a id="in3" href="./suaTTClient.php">Cập nhật</a></th>
                </tr>
            </table>
        </div>
